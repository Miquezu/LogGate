...
/// <summary>
/// Сервис формирования печатного макета FlowDocument и вывода на печать досье сотрудника.
/// </summary>
public class PrintService : IPrintService
{
        ...
        IEnumerable<DailyWorkRecord> records)
    {
        ...
        tsTable.Columns.Add(new TableColumn { Width = new GridLength(85) });
        tsTable.Columns.Add(new TableColumn { Width = new GridLength(85) });
        tsTable.Columns.Add(new TableColumn { Width = new GridLength(68) });
        tsTable.Columns.Add(new TableColumn { Width = new GridLength(68) });
        tsTable.Columns.Add(new TableColumn { Width = new GridLength(58) });
        tsTable.Columns.Add(new TableColumn { Width = new GridLength(85) });
        tsTable.Columns.Add(new TableColumn { Width = new GridLength(75) });
        tsTable.Columns.Add(new TableColumn { Width = new GridLength(75) });
        tsTable.Columns.Add(new TableColumn { Width = new GridLength(94) });
